    ...
    <>
      <div className="mobile-app">
        <div className="grid-container">
          <div className="app-h1">Mobil uygulamamızı indirin</div>
        </div>
        <div className="grid-container">
          <div className="download-grid">
            <div className="download-grid-child">
              <div className="download-grid-child-left">
                  ...
                  <div className="content-subtitle">
                    <div className="content-description">
                      <div className="content-QR-container">
                        <img
                          src="https://images.deliveryhero.io/image/foodpanda/homepage/trhomepageqrcode.png"
                          alt="banner"
                          className="content-QR"
                        />
                      </div>
                      <div className="content-description-text">
                        Yemek, hızlı market ya da çevredeki esnaflardan tüm
                        ihtiyaçların dakikalar içinde kapında. Yemeksepeti’ni
                        indir, sepetini oluşturup siparişini ver, online ya da
                        kapıda dilediğin gibi öde.
                      </div>
                    </div>
                    <div className="stores">
                      <a
                        href="https://utsh.adj.st/?adj_t=12d0wowa&amp;adj_deep_link=yemeksepeti%3A%2F%2F%3F&amp;adj_campaign=tr_homepage_ios&amp;wssid=1725021546578.434766677719499258.nefr9fabuq"
                        target="_blank"
                        class="apple-store"
                      ...
                      <a
                        href="https://utsh.adj.st/?adj_t=12e25dhg&amp;adj_deep_link=yemeksepeti%3A%2F%2F%3F&amp;adj_campaign=tr_homepage_android&amp;wssid=1725021546578.434766677719499258.nefr9fabuq"
                        target="_blank"
                        class="play-store"
                      ...
                      <a
                        href="https://utsh.adj.st/?adj_t=128rlk44&amp;adj_deep_link=yemeksepeti%3A%2F%2F%3F&amp;adj_campaign=tr_homepage_huawei&amp;wssid=1725021546578.434766677719499258.nefr9fabuq"
                        target="_blank"
                        class="huawei-store"
              ...
              <div className="download-grid-child-right">
                <div className="app-download-image">
                    <picture>
                    <source srcset="https://images.deliveryhero.io/image/foodpanda/home-yemeksepeti-apps.png?width=2000&amp;height=1590, https://images.deliveryhero.io/image/foodpanda/home-yemeksepeti-apps.png?width=4000&amp;height=3180 2x" media="(min-width: 2000px)"/>
                    <source srcset="https://images.deliveryhero.io/image/foodpanda/home-yemeksepeti-apps.png?width=1400&amp;height=1113, https://images.deliveryhero.io/image/foodpanda/home-yemeksepeti-apps.png?width=2800&amp;height=2226 2x" media="(min-width: 1400px)"></source>
                    <source srcset="https://images.deliveryhero.io/image/foodpanda/home-yemeksepeti-apps.png?width=1200&amp;height=954, https://images.deliveryhero.io/image/foodpanda/home-yemeksepeti-apps.png?width=2400&amp;height=1908 2x" media="(min-width: 1200px)"></source>
                    <source srcset="https://images.deliveryhero.io/image/foodpanda/home-yemeksepeti-apps.png?width=1000&amp;height=795, https://images.deliveryhero.io/image/foodpanda/home-yemeksepeti-apps.png?width=2000&amp;height=1590 2x" media="(min-width: 1000px)"></source>
                    <source srcset="https://images.deliveryhero.io/image/foodpanda/home-yemeksepeti-apps.png?width=800&amp;height=636, https://images.deliveryhero.io/image/foodpanda/home-yemeksepeti-apps.png?width=1600&amp;height=1272 2x" media="(min-width: 800px)"></source>
                    <source srcset="https://images.deliveryhero.io/image/foodpanda/home-yemeksepeti-apps.png?width=600&amp;height=477, https://images.deliveryhero.io/image/foodpanda/home-yemeksepeti-apps.png?width=1200&amp;height=954 2x" media="(min-width: 600px)"></source>
                    <source srcset="https://images.deliveryhero.io/image/foodpanda/home-yemeksepeti-apps.png?width=400&amp;height=318, https://images.deliveryhero.io/image/foodpanda/home-yemeksepeti-apps.png?width=800&amp;height=636 2x" media="(min-width: 400px)"></source>
                    <source srcset="https://images.deliveryhero.io/image/foodpanda/home-yemeksepeti-apps.png?width=300&amp;height=238.5, https://images.deliveryhero.io/image/foodpanda/home-yemeksepeti-apps.png?width=600&amp;height=477 2x" media="(min-width: 300px)"></source>
                    <img class="" src="https://images.deliveryhero.io/image/foodpanda/home-yemeksepeti-apps.png?width=2000&amp;height=1590" alt="banner" data-testid="banner"></img>
